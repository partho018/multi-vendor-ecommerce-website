    ...
    <footer className="bg-white mt-[5px] border-t border-gray-100">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="flex flex-col sm:flex-row sm:items-start gap-6">
          ...
          {/* Links columns - stack side by side on mobile */}
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-4 sm:py-6 flex flex-col sm:flex-row gap-6 sm:gap-10">
          ...
          <div className="flex-1 flex flex-col sm:items-center">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2 flex-wrap">
                <img src="/del-lazlogistics.png" alt="Lazada Logistics" className="h-7 sm:h-8 object-contain" />
                <img src="/del-ninjavan.png" alt="Ninja Van" className="h-7 sm:h-8 object-contain" />
                <img src="/del-skynet.png" alt="SkyNet" className="h-7 sm:h-8 object-contain" />
              </div>
              <div className="flex items-center gap-2">
                <img src="/del-jt-express.png" alt="J&T Express" className="h-7 sm:h-8 object-contain" />
                <img src="/del-jt-cargo.png" alt="J&T Cargo" className="h-7 sm:h-8 object-contain" />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <img src="/ver-iso27001.png" alt="ISO/IEC 27001" className="h-12 sm:h-14 object-contain" />
              <img src="/ver-pcidss.png" alt="PCI DSS" className="h-12 sm:h-14 object-contain" />
            </div>
          </div>
